...
const glow = keyframes`
  ...
  50% { box-shadow: 0 0 40px rgba(255, 255, 255, 0.4), 0 0 60px rgba(186, 230, 253, 0.3); }
`;
    ...
    <PageContainer>
      <LeftPanel>
        ...
        <BrandContent>
          ...
          <FeatureList>
            <FeatureItem delay={0.4}><CheckCircle2 size={20} /> Real-time Collaboration</FeatureItem>
            <FeatureItem delay={0.6}><CheckCircle2 size={20} /> Advanced Sprint Planning</FeatureItem>
            <FeatureItem delay={0.8}><CheckCircle2 size={20} /> AI-Powered Insights</FeatureItem>
          </FeatureList>
        </BrandContent>
        <FloatingCard>
