...
router.get('/sprint-burndown/:sprintId', async (req, res) => {
  try {
    const data = await reportingService.getSprintBurndown(req.params.sprintId);
    res.json(data);
  } catch (error: any) {
...
router.get('/velocity/:projectId', async (req, res) => {
  try {
    const sprints = parseInt(req.query.sprints as string) || 6;
    const data = await reportingService.getVelocityChart(req.params.projectId, sprints);
    res.json(data);
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
...
router.get('/cumulative-flow/:projectId', async (req, res) => {
  try {
    const days = parseInt(req.query.days as string) || 30;
    const data = await reportingService.getCumulativeFlow(req.params.projectId, days);
    res.json(data);
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
...
router.get('/created-vs-resolved/:projectId', async (req, res) => {
  try {
    const days = parseInt(req.query.days as string) || 30;
    const data = await reportingService.getCreatedVsResolved(req.params.projectId, days);
    res.json(data);
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
...
router.get('/pie-chart/:projectId', async (req, res) => {
  try {
    ...
    const data = await reportingService.getPieChartData(req.params.projectId, groupBy);
    res.json(data);
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
...
router.get('/time-tracking/:projectId', async (req, res) => {
  try {
    const data = await reportingService.getTimeTrackingReport(req.params.projectId);
    res.json(data);
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
...
router.get('/average-age/:projectId', async (req, res) => {
  try {
    const data = await reportingService.getAverageAgeReport(req.params.projectId);
    res.json(data);
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
...
router.get('/resolution-time/:projectId', async (req, res) => {
  try {
    const data = await reportingService.getResolutionTimeReport(req.params.projectId);
    res.json(data);
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
...
router.get('/user-workload/:projectId', async (req, res) => {
  try {
    const data = await reportingService.getUserWorkloadReport(req.params.projectId);
    res.json(data);
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
...
router.get('/sprint-report/:sprintId', async (req, res) => {
  try {
    const data = await reportingService.getSprintReport(req.params.sprintId);
    res.json(data);
  } catch (error: any) {
    res.status(500).json({ error: error.message });
  }
