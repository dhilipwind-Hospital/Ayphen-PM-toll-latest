...
const ProjectInvitation_1 = require("../entities/ProjectInvitation");
...
const invitationRepo = database_1.AppDataSource.getRepository(ProjectInvitation_1.ProjectInvitation);
...
router.post('/', async (req, res) => {
    try {
        ...
        try {
            ...
            await email_service_1.emailService.sendProjectInvitation({
                to: email,
