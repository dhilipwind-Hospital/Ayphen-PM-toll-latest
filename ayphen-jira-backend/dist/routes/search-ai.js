...
router.post('/ai', async (req, res) => {
    ...
    `;
        ...
        const results = await database_1.AppDataSource.query(searchQuery, params);
        const formattedResults = results.map((issue) => ({
            id: issue.id,
            type: 'issue',
...
router.post('/duplicates', async (req, res) => {
    ...
    `;
        ...
        const duplicates = await database_1.AppDataSource.query(searchQuery, params);
        res.json({
