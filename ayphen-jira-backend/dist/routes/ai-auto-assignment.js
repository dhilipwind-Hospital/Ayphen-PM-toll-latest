...
const ai_auto_assignment_service_1 = require("../services/ai-auto-assignment.service");
...
router.post('/suggest/:issueId', async (req, res) => {
    try {
        ...
        const result = await ai_auto_assignment_service_1.aiAutoAssignmentService.autoAssignIssue(issueId);
        res.json({
            success: true,
            data: result,
...
router.post('/bulk-suggest', async (req, res) => {
    try {
        ...
        const results = await ai_auto_assignment_service_1.aiAutoAssignmentService.bulkAutoAssign(issueIds);
...
router.post('/feedback', async (req, res) => {
    try {
        ...
        await ai_auto_assignment_service_1.aiAutoAssignmentService.recordAssignmentFeedback(issueId, recommendedUserId, actualUserId, wasAccepted);
        res.json({
            success: true,
