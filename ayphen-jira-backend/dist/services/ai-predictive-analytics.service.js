...
exports.aiPredictiveAnalyticsService = exports.AIPredictiveAnalyticsService = void 0;
...
class AIPredictiveAnalyticsService {
     ...
     */
    async predictVelocityTrend(projectId) {
        try {
     ...
     */
    async assessProjectHealth(projectId) {
        try {
            const issueRepo = database_1.AppDataSource.getRepository(Issue_1.Issue);
            const sprintRepo = database_1.AppDataSource.getRepository(Sprint_1.Sprint);
     ...
     */
    async suggestImprovements(projectId, data) {
        const suggestions = [];
     ...
     */
    async predictIssueCompletionTime(issueId) {
        try {
            const issueRepo = database_1.AppDataSource.getRepository(Issue_1.Issue);
            ...
            const priorityFactor = priorityMultiplier[issue.priority] || 1.0;
            factors.push({
                name: 'Priority',
     ...
     * Find similar completed issues
     */
    async findSimilarCompletedIssues(issue) {
        try {
            const issueRepo = database_1.AppDataSource.getRepository(Issue_1.Issue);
    ...
    estimateByStoryPoints(points) {
        ...
        return baseEstimate[points] || points;
    }
}
exports.AIPredictiveAnalyticsService = AIPredictiveAnalyticsService;
exports.aiPredictiveAnalyticsService = new AIPredictiveAnalyticsService();
