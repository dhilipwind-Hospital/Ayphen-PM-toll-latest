...
exports.markAllAsRead = exports.markAsRead = exports.getUnreadCount = exports.notifyAccessGranted = exports.notifyRoleChanged = exports.notifyMemberRemoved = exports.notifyMemberAdded = exports.createNotification = void 0;
...
const notifyMemberAdded = async (userId, projectId, role, addedById) => {
    try {
      ...
      `;
            await email_service_1.emailService.sendEmail(user.email, subject, html);
        }
    }
    catch (error) {
...
exports.notifyMemberAdded = notifyMemberAdded;
// Send notification when member is removed from project
const notifyMemberRemoved = async (userId, projectId, removedById) => {
    try {
...
exports.notifyMemberRemoved = notifyMemberRemoved;
// Send notification when member role changes
const notifyRoleChanged = async (userId, projectId, oldRole, newRole, changedById) => {
    try {
...
const notifyAccessGranted = async (userId, projectId, grantedById) => {
    try {
...
exports.notifyAccessGranted = notifyAccessGranted;
