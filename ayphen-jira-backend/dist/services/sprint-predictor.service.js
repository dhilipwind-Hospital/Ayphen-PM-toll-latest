...
exports.sprintPredictorService = exports.SprintPredictorService = void 0;
...
class SprintPredictorService {
    ...
    async predictSprintSuccess(sprintId) {
        ...
        try {
            ...
            const historicalMetrics = await Promise.all(historicalSprints.map(s => ai_retrospective_analyzer_service_1.aiRetrospectiveAnalyzer.getSprintMetrics(s.id)));
            ...
            const recommendations = await this.generateRecommendations(plannedPoints, avgVelocity, risks, probability, plannedIssues);
            return {
     ...
     */
    identifyRisks(plannedPoints, avgVelocity, issues, avgBugs) {
        const risks = [];
     ...
     */
    async generateRecommendations(plannedPoints, avgVelocity, risks, probability, issues) {
...
exports.SprintPredictorService = SprintPredictorService;
// Export singleton instance
exports.sprintPredictorService = new SprintPredictorService();
