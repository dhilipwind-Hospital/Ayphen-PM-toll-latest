...
exports.aiAutoAssignmentService = exports.AIAutoAssignmentService = void 0;
const database_1 = require("../config/database");
const Issue_1 = require("../entities/Issue");
const User_1 = require("../entities/User");
const ProjectMember_1 = require("../entities/ProjectMember");
const axios_1 = __importDefault(require("axios"));
class AIAutoAssignmentService {
    constructor() {
    ...
    async autoAssignIssue(issueId) {
        try {
            ...
            const scores = await Promise.all(teamMembers.map(member => this.scoreTeamMember(member, issue, issueAnalysis)));
...
- Estimate based on type and description complexity`;
     ...
     */
    async scoreTeamMember(user, issue, analysis) {
        const reasons = [];
        ...
        const finalScore = (expertiseScore * 0.4 +
            workloadScore * 0.4 +
     ...
     */
    async calculateExpertiseScore(userId, issue, requiredSkills, reasons) {
        const issueRepo = database_1.AppDataSource.getRepository(Issue_1.Issue);
     ...
     */
    async calculateWorkloadScore(userId, projectId, reasons) {
        const issueRepo = database_1.AppDataSource.getRepository(Issue_1.Issue);
     ...
     */
    calculateAvailabilityScore(user, reasons) {
     ...
     */
    async recordAssignmentFeedback(issueId, recommendedUserId, actualUserId, wasAccepted) {
...
exports.AIAutoAssignmentService = AIAutoAssignmentService;
exports.aiAutoAssignmentService = new AIAutoAssignmentService();
