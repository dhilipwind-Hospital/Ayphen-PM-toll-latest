...
exports.aiDescriptionPromptService = exports.AIDescriptionPromptService = void 0;
class AIDescriptionPromptService {
    /**
    ...
    buildStoryPrompt(summary, userInput, context, format) {
...
Generate the description now:`;
    ...
    buildBugPrompt(summary, userInput, context) {
...
Generate the bug description now:`;
    ...
    buildTaskPrompt(summary, userInput, context) {
...
Generate the task description now:`;
    ...
    buildEpicPrompt(summary, userInput, context) {
...
Generate the epic description now:`;
    ...
    buildSubtaskPrompt(summary, userInput, context) {
...
Generate the subtask description now:`;
    ...
    buildGenericPrompt(summary, userInput, context) {
...
exports.AIDescriptionPromptService = AIDescriptionPromptService;
exports.aiDescriptionPromptService = new AIDescriptionPromptService();
