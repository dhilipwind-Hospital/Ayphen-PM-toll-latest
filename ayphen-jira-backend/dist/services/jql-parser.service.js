...
exports.jqlParserService = exports.JQLParserService = void 0;
class JQLParserService {
     ...
     */
    getAutocompleteSuggestions(jql, cursorPosition) {
        ...
        return allSuggestions.filter(s => s.toLowerCase().startsWith(lastToken.toLowerCase()));
    }
}
exports.JQLParserService = JQLParserService;
exports.jqlParserService = new JQLParserService();
