...
exports.voiceConversationContext = exports.VoiceConversationContextService = void 0;
class VoiceConversationContextService {
    constructor() {
     ...
     */
    addCommand(userId, transcript, intent, entities, success, issueId, projectId) {
     ...
     */
    resolveReferences(userId, transcript) {
        const context = this.getContext(userId);
     ...
     */
    learnFromCorrection(userId, originalTranscript, correctedTranscript, correctIntent) {
        const context = this.getContext(userId);
...
exports.VoiceConversationContextService = VoiceConversationContextService;
// Export singleton instance
exports.voiceConversationContext = new VoiceConversationContextService();
// Cleanup expired sessions every 10 minutes
setInterval(() => {
    const cleaned = exports.voiceConversationContext.cleanupExpiredSessions();
    if (cleaned > 0) {
