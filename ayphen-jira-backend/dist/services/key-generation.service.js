...
class KeyGenerationService {
     ...
     * Example: PROJ-100
     */
    generateEpicKey(projectKey, epicNumber) {
     ...
     * Example: PROJ-201
     */
    generateStoryKey(projectKey, storyNumber) {
     ...
     */
    generateTestCaseKey(epicKey, tcNumber) {
     ...
     */
    generateSuiteKey(category, epicKey) {
        const epicKeyNoDash = epicKey.replace('-', '');
     ...
     */
    async getNextTestCaseNumber(epicKey) {
        try {
